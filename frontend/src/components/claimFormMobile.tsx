...
export default function ClaimForm() {
    ...
    const sendSignupData = async (userData: any) => {
        const response = await fetch("https://tweetfluencer.memgraph.com/api/signup", {
            method: 'POST',
            mode: 'cors',
        ...
        <div>
            ...
            <div className={styles.claimForm}>
                <Grid container spacing={3}>
                    ...
                    <Grid item sm={12}>
                        <button id="" className={styles.joinButton} onClick={handleJoin} disabled={!isUsernameValid}>JOIN</button>
                    </Grid>
                </Grid>
            </div>
