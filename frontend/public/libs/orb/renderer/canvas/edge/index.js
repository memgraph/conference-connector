import { EdgeCurved, EdgeLoopback, EdgeStraight } from '../../../models/edge';
...
export const drawEdge = (context, edge, options) => {
    var _a, _b;
    if (!edge.getWidth()) {
        return;
    }
...
const drawEdgeLabel = (context, edge) => {
...
const setupCanvas = (context, edge) => {
...
const setupShadow = (context, edge) => {
...
const clearShadow = (context, edge) => {
    if (edge.properties.shadowColor) {
 ...
 */
const transformArrowPoints = (points, arrow) => {
