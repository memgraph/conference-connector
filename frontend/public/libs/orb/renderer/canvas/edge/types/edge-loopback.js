export const drawLoopbackLine = (context, edge) => {
 ...
 */
export const getLoopbackArrowShape = (edge) => {
    var _a, _b;
 ...
 * @private
 */
const pointOnCircle = (circle, percentage) => {
...
//# sourceMappingURL=edge-loopback.js.map